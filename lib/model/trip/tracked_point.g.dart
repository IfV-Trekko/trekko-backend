...
const TrackedPointSchema = Schema(
  name: r'TrackedPoint',
  ...
  estimateSize: _trackedPointEstimateSize,
  serialize: _trackedPointSerialize,
  deserialize: _trackedPointDeserialize,
  deserializeProp: _trackedPointDeserializeProp,
);

int _trackedPointEstimateSize(
  TrackedPoint object,
  List<int> offsets,
...
P _trackedPointDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
