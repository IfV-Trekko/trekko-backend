...
const LogEntrySchema = CollectionSchema(
  ...
  properties: {
    r'level': PropertySchema(
      ...
      name: r'level',
      type: IsarType.byte,
      enumMap: _LogEntrylevelEnumValueMap,
    ),
...
LogEntry _logEntryDeserialize(
  ...
  final object = LogEntry(
    _LogEntrylevelValueEnumMap[reader.readByteOrNull(offsets[0])] ??
        LogLevel.info,
...
P _logEntryDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (_LogEntrylevelValueEnumMap[reader.readByteOrNull(offset)] ??
          LogLevel.info) as P;
    case 1:
...
const _LogEntrylevelEnumValueMap = {
  'info': 0,
  'warning': 1,
  'error': 2,
};
const _LogEntrylevelValueEnumMap = {
  0: LogLevel.info,
  1: LogLevel.warning,
  2: LogLevel.error,
};
...
extension LogEntryQueryProperty
  ...
  QueryBuilder<LogEntry, LogLevel, QQueryOperations> levelProperty() {
    return QueryBuilder.apply(this, (query) {
