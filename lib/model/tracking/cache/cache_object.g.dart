...
extension CacheObjectQueryFilter
  ...
  QueryBuilder<CacheObject, CacheObject, QAfterFilterCondition> valueLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<CacheObject, CacheObject, QAfterFilterCondition> valueBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<CacheObject, CacheObject, QAfterFilterCondition> valueStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CacheObject, CacheObject, QAfterFilterCondition> valueEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CacheObject, CacheObject, QAfterFilterCondition> valueContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CacheObject, CacheObject, QAfterFilterCondition> valueMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CacheObject, CacheObject, QAfterFilterCondition> valueIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'value',
        value: '',
...
extension CacheObjectQuerySortBy
  ...
  QueryBuilder<CacheObject, CacheObject, QAfterSortBy> sortByValueDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CacheObjectQuerySortThenBy
  ...
  QueryBuilder<CacheObject, CacheObject, QAfterSortBy> thenByValueDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'value', Sort.desc);
    });
  }
...
extension CacheObjectQueryProperty
  ...
  QueryBuilder<CacheObject, String, QQueryOperations> valueProperty() {
    return QueryBuilder.apply(this, (query) {
